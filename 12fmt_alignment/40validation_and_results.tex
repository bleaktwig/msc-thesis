...
% --+ Data used +---------------------------------------------------------------
    ...
    \input{12fmt_alignment/41cuts}
    \input{12fmt_alignment/42geometry_effect}
    \input{12fmt_alignment/43vertex_resolution_improvement}
    \input{12fmt_alignment/44conclusions}
