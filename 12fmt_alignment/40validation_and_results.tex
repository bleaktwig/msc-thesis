...
% --+ Geometry issue +----------------------------------------------------------
    ...
    All windows are made of aluminium and have a thickness of $15$ micrometers. % NOTE. I should add a citation here.
    ...
    \begin{figure}[t!]
        \centering\frame{
        \includegraphics[scale=0.24]{40theta_dc_vs_fmt.png}}
...
% --+ Conclusions +-------------------------------------------------------------
    ...
    This, for example, allows for double targets to be placed closer to each other, benefiting the physics derived from such experiments, such as the RG-E run. % NOTE. A citation would be nice here.
...
% --+ Why no improvements is seen on vertex momentum resolution +---------------
    ...
    This means that the detector cannot provide a good contribution to the vertex momentum resolution, since there is not enough data added to the track's momentum. % NOTE. A citation would be nice here.
...
% --+ Show detector efficiency +------------------------------------------------
    ...
    \begin{figure}[b]
        \centering\frame{
        \includegraphics[width=\textwidth]{40fmt_efficiency.png}}
