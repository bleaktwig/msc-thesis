% !TEX root = ../main.tex
\subsection{Forward Micromegas Tracker}
\label{12.10::forward_micromegas_tracker}
% --+ Micromegas +--------------------------------------------------------------
    \begin{figure}[b!]
        \frame{\includegraphics[width=\textwidth]{10mm_principle.pdf}}
        \caption[Micromegas (MM) working principle]
        {Micromegas (MM) working principle.}
        \floatfoot{Source: Author's re-render of original illustration in \cite{giomataris1996}, using \href{https://inkscape.org/}{Inkscape}.}
...
% --+ Micromegas in CLAS12 +----------------------------------------------------
    ...
    \begin{figure}[b!]
        \frame{\includegraphics[scale=0.5]{10mvt.png}}
...
% --+ FMT +---------------------------------------------------------------------
    ...
    \begin{wrapfigure}{r}{0.50\textwidth}
        \frame{\includegraphics[width=\linewidth]{10fmt_recon.pdf}}
    ...
    \begin{figure}[t]
        \frame{\includegraphics[width=\textwidth]{10fmt_geometry.pdf}}
    ...
    \input{12fmt_alignment/11fmt_track_reconstruction}
