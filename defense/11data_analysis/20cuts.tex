...
\begin{frame}{DIS Cuts}
    ...
    \begin{itemize}
        ...
        \item
            To exclude nucleon resonances, the squared mass of the final hadronic state\appref{12.14::dis_variables} is restricted: \textcolor{efd_yellow}{$W^2 > 4 \text{ GeV}^2$}.
