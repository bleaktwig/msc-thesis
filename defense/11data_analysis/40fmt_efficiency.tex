...
\begin{frame}{FMT Efficiency: Geometry Effect}
    ...
    \vspace{6pt}
    We then apply a cut on DC and DC+FMT tracks based on this region.
\end{frame}
...
\begin{frame}{FMT Efficiency: Geometry Effect}
    ...
    Graphically, the correspondence of \efe{$\theta_\text{min}$} and \efe{$\theta_\text{max}$} with FMT's acceptance is evident.
    ...
    \begin{center}
        ...
        \end{figure}
        \scriptsize{\textit{
            \efe{$v_z$} vs. \efe{$\theta$} for DC and DC+FMT.
