...
\begin{frame}{FMT Efficiency: Reconstruction Effect}
    ...
    \begin{flushright}
        \tiny{\textit{A full efficiency study can be seen in slides \textcolor{efd_purple}{\ref{20.04::fmt_efficiency_study}} to \textcolor{efd_purple}{\ref{20.04::fmt_efficiency_study_end}}.}}
    \end{flushright}
\end{frame}
