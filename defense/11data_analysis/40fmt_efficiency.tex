...
\begin{frame}{FMT Efficiency}
    ...
    \begin{itemize}
        \item
            Initially, the plan was to work with run \ef{12933} (10.4 GeV beam, 250 nA), but analysis showed a very poor FMT efficiency.
...
\begin{frame}{FMT Efficiency: Geometry Effect}
    ...
    \begin{itemize}
        ...
        \vspace{6pt}
        \item
            If we want to understand the behaviour of DIS variables, we need to study this effect and disentangle it from acceptance.
    \end{itemize}
...
\begin{frame}{FMT Efficiency: Geometry Effect}
    ...
    Graphically, the correspondance of \ef{$R_\text{min}$} and \ef{$R_\text{max}$} with FMT's acceptance is evident.
    ...
    \begin{center}
        ...
        \end{figure}
        \scriptsize{\textit{
            \ef{$v_z$} vs. \ef{$\theta$} for DC and FMT.
            The \ef{$R_\text{min}$} and \ef{$R_\text{max}$} curves are highlighted in red.
        }}
    \end{center}
\end{frame}
