...
\begin{frame}{Acceptance Correction: $Q^2$ and $\nu$}
    ...
    \begin{itemize}
        \item
            A drop in \ef{$Q^2$} acceptance is perceived from \ef{$1$ to $4$} \textcolor{efd_green}{$\text{GeV}^2$}.
...
\begin{frame}{Acceptance Correction: $Q^2$ $\theta$ dependence}
    ...
    \begin{itemize}
        \item
            \ef{$Q^2$} depends quadratically on the scattered $e^-$ scattering angle \ef{$\theta_C$}.

        \item
            The CLAS12 Forward Detector has a small efficiency for \ef{$\theta \lsim 0.15$} \textcolor{efd_green}{radians}.
