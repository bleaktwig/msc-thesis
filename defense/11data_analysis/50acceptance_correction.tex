...
\begin{frame}{Acceptance Correction: Generation + Simulation}
    ...
    \begin{itemize}
        ...
        \item
            It is the ratio between the \ef{generated events} and \ef{accepted events}.

        \item
            10M DIS events we generated in \ef{LEPTO}, simulated in \ef{GEMC 5.2}, and reconstructed with \ef{Coatjava 8.2.0}.
    \end{itemize}
    ...
    \begin{center}
        \scriptsize{\textit{
            \ef{$v_z$} for \textbf{\textcolor[HTML]{c7eca6}{DC (green)}} and \textbf{\textcolor[HTML]{8dcfbf}{DC+FMT (cyan)}} tracks.
        }}
    \end{center}
\end{frame}
...
\begin{frame}{Acceptance Correction: $Q^2$ $\theta$ dependence}
    ...
    \begin{itemize}
        \item
            \efe{$Q^2$} depends quadratically on the sine of the scattered $e^-$ scattering angle \efe{$\theta_C$}.
...
\begin{frame}{Acceptance Correction: $z_h$}
    ...
    \begin{itemize}
        ...
        \item
            ...
            % Positive particles bend "outward", towards the wider part of each DC sector.
            % Negative particles bend "inward", towards the tip of each DC triangle.
    \end{itemize}
...
\begin{frame}{Acceptance Correction: $p_T^2$}
    ...
    \begin{itemize}
        ...
        \vspace{6pt}
        \item
            Few particles have a \efe{$p_T^2 \gsim 1.4 \text{ GeV}^2$}, hence the strange values and large errors.
    \end{itemize}
