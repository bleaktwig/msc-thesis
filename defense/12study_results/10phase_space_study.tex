...
\begin{frame}{Phase Space Study: $z_h$}
    ...
    \begin{column}{.44\linewidth}
        ...
        \begin{center}
            \begin{figure}[t]
                \centering{
                    \fbox{\includegraphics[width=\textwidth]{14zh_pi-.png}}
                }
    ...
    \begin{column}{.54\linewidth}
        \begin{itemize}
            ...
            % TODO. Maybe explain the difference between positive and negative pions.
        \end{itemize}
...
\begin{frame}{Phase Space Study: $p_T^2$}
    ...
    \begin{column}{.44\linewidth}
        ...
        \begin{center}
            \begin{figure}[t]
                \centering{
                    \fbox{\includegraphics[width=\textwidth]{15pt2_pi-.png}}
                }
...
\begin{frame}{Phase Space Study: $\phi_{PQ}$}
    ...
    \begin{column}{.44\linewidth}
        ...
        \begin{center}
            \begin{figure}[t]
                \centering{
                    \fbox{\includegraphics[width=\textwidth]{16phipq_pi-.png}}
                }
