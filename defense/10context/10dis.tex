...
\begin{frame}{DIS: Kinematic Variables}
    ...
    \begin{itemize}
        ...
        \item
            The hadron's transverse momentum \ef{$p_T$} and the angle between the leptonic and hadronic planes \ef{$\phi_{PQ}$} can be understood in the figure.
    \end{itemize}
...
\begin{frame}{Hadronisation}
    ...
    \begin{center}
        \begin{figure}[t]
            \centering{
                \fbox{\includegraphics[width=\textwidth]{13hadronisation.pdf}}
            }
        \end{figure}
    \end{center}
