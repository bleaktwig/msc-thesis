% !TEX root = ../main.tex
% --+ 20.11 ACCEPTANCE ERROR ESTIMATION +---------------------------------------
...
\begin{frame}{Acceptance Error Estimation}
    ...
    Now, replacing \ef{$y_\text{acc}$} with its definition from Equation \eqref{eq::20.11::acc}, we arrive at the final error expression
    \begin{equation}
