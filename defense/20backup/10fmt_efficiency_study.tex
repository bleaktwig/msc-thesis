...
\begin{frame}{FMT Efficiency Study: $v_z$}
    \begin{center}
        ...
        \begin{figure}[t]
            \centering{
                \fbox{\includegraphics[width=0.98\textwidth]{10eff_vz.pdf}}
            }
        \end{figure}
...
\begin{frame}{FMT Efficiency Study: $\theta$}
    \begin{center}
        ...
        \begin{figure}[t]
            \centering{
                \fbox{\includegraphics[width=0.98\textwidth]{10eff_theta.pdf}}
            }
        \end{figure}
...
\begin{frame}{FMT Efficiency Study: $p$}
    \begin{center}
        ...
        \begin{figure}[t]
            \centering{
                \fbox{\includegraphics[width=0.98\textwidth]{10eff_p.pdf}}
            }
        \end{figure}
...
\begin{frame}{FMT Efficiency Study: $\varphi$}
    \begin{center}
        ...
        \begin{figure}[t]
            \centering{
                \fbox{\includegraphics[width=0.98\textwidth]{10eff_phi.pdf}}
            }
        \end{figure}
...
\begin{frame}{FMT Efficiency Study: $\varphi$}
    ...
    \begin{center}
        \begin{figure}[t]
            \centering{
                \fbox{\includegraphics[width=0.98\textwidth]{10gcut_phi.pdf}}
            }
        \end{figure}
    \end{center}
