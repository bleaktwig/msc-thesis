...
% --+ Introduction +------------------------------------------------------------
    \begin{wrapfigure}{r}{0.50\textwidth}
        \frame{\includegraphics[width=\linewidth]{231cvt_pres.png}}
    ...
    \begin{wrapfigure}{r}{0.50\textwidth}
        \frame{\includegraphics[width=\linewidth]{231dc_pres.png}}
...
% --+ Reconstruction +----------------------------------------------------------
    ...
    \begin{figure}[t]
        \frame{\includegraphics[width=\textwidth]{231ced_event.png}}
