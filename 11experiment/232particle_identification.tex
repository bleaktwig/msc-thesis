...
% --+ Charged particle identification +-----------------------------------------
    ...
    \begin{wrapfigure}{r}{0.49\textwidth}
        \centering\frame{
        \includegraphics[width=\linewidth]{11experiment/img/232pos_pid.png}}
    ...
    For charged particles, the identification process begins by utilizing calorimetry and Cherenkov information to positively identify $e^-/e^+$ candidates in the FD.
    ...
    \begin{wrapfigure}{r}{0.50\textwidth}
        \centering\frame{
        \includegraphics[width=\linewidth]{11experiment/img/232n_gamma.png}}
