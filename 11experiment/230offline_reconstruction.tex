...
% --+ CLARA +-------------------------------------------------------------------
    ...
    The input and output data are organized in tabular structures known as ``banks'', which are configured by the service developer to match the specific requirements of the service.
    ...
    This engine provides common components such as initialization and event processing methods, reducing the development complexity of individual micro-services and enforcing a uniform structure throughout the framework.
    ...
    \begin{figure}[b!]
        \centering\frame{
        \includegraphics[width=\textwidth]{11experiment/img/230recon_chain.pdf}}
...
% --+ CLAS12 reconstruction +---------------------------------------------------
    ...
    Each entry in the bank represents a decoded detector hit and contains information such as sector, layer, component, order, and digitized data like signal charge, amplitude, time, or pedestal.
