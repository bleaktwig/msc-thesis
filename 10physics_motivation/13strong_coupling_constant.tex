...
\label{10.13::strong_coupling_constant}
    ...
    \begin{figure}[t!]
        ...
        The measured values are compared with the theoretical predictions of renormalised evolution with an initial value of $\alpha_s(m_z) = 0.117$ GeV.} % NOTE. Can't find a source :(.
