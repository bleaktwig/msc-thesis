...
\label{14.22::hadronic_variables}
    ...
    % pt2.
    Regarding $p_T^2$, which was initially described in Section \ref{13.40::acceptance_correction}, it is defined as follows
    \begin{equation*}
        p_T^2 = p_h^2 \cdot \left(1 - \cos^2(\theta_{PQ})\right),
    \end{equation*}
    where $p_h$ represents the momentum of the hadron in the lab frame, and $\theta_{PQ}$ is the angle between the virtual interaction photon and the detected hadron.
    ...
    This behavior has been observed and documented in DIS analysis publications such as \cite{moran2022}.
