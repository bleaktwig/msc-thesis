...
% --+ Separated. +--------------------------------------------------------------
    ...
    Based on the very low efficiency for 3-layer FMT tracks perceived in Figures \ref{fig::14.14::fmt_efficiencies} and \ref{fig::14.14::phi_study}, subsequent parts of this study will only consider DC and 2-layer FMT tracks.
