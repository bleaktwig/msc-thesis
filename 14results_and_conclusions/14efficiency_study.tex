...
% --+ Integrated. +-------------------------------------------------------------
    ...
    % NOTE. Table with simulation data -- too wide for page.
    % \begin{table}[b]
    %     \begin{center}
    ...
    %             \midrule \midrule
    %             \textbf{$e^-$}      & 2 layers & & 25.1 $\pm$ 1.5 & 37.5 $\pm$ 0.7 & & 32.7 $\pm$  2.5 & 53.7 $\pm$ 0.8 & & 71.7 $\pm$ 5.7 & 92.1 $\pm$ 1.3 \\
    %                                 & 3 layers & &  5.6 $\pm$ 8.8 &  8.5 $\pm$ 5.0 & &  9.9 $\pm$ 17.2 & 16.4 $\pm$ 8.3 & & 59.8 $\pm$ 2.9 & 78.7 $\pm$ 7.4 \\
    %             \midrule
    %             \textbf{$e^-\pi^+$} & 2 layers & &  6.5 $\pm$ 0.2 & 13.7 $\pm$ 0.9 & & 11.1 $\pm$ 0.2 & 28.0 $\pm$ 1.3 & & 39.1 $\pm$ 1.5 & 73.2 $\pm$ 4.0 \\
    %                                 & 3 layers & &  0.3 $\pm$ 0.6 &  0.7 $\pm$ 2.7 & &  1.0 $\pm$ 0.6 &  2.7 $\pm$ 5.8 & & 24.3 $\pm$ 6.0 & 47.5 $\pm$ 2.6 \\
    %             \midrule
    %             \textbf{$e^-\pi^-$} & 2 layers & &  5.6 $\pm$ 0.0 & 14.2 $\pm$ 1.0 & &  8.9 $\pm$ 0.4 & 29.5 $\pm$ 3.4 & & 26.7 $\pm$ 2.1 & 57.1 $\pm$ 7.4 \\
    %                                 & 3 layers & &  0.3 $\pm$ 0.0 &  0.7 $\pm$ 3.0 & &  0.9 $\pm$ 1.7 &  2.9 $\pm$ 6.4 & & 13.2 $\pm$ 6.7 & 29.5 $\pm$ 4.3 \\
    %             \bottomrule
    %         \end{tabularx}
    %     \end{center}
    %     \caption[FMT efficiency study results]
