...
% --+ Integrated. +-------------------------------------------------------------
    ...
    \end{equation*}
    the efficiency $E_2$ for 2-layer tracks can be obtained using the probabilities $P(L_n)$ as follows
    \begin{align}
    ...
    For 3-layer tracks, the efficiency $E_3$ can be directly obtained as
    \begin{align}
    ...
    Using equations \eqref{eq::14.14::efficiency2} and \eqref{eq::14.14::efficiency3}, we can estimate the weighted average efficiency $\xoverline{E_1}$ as
    \begin{equation*}
    ...
    The corresponding errors were obtained and included in the table.
